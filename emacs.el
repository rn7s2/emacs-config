...
(custom-set-variables
 ...
 '(display-time-mode t)
 '(fill-column 80)
 '(geiser-racket-init-file "~/.emacs-config/racket-geiser.rkt")
 '(global-display-line-numbers-mode t)
 '(indent-tabs-mode nil)
 '(inhibit-startup-screen t)
 '(package-selected-packages
   '(astyle company cnfonts exec-path-from-shell eglot geiser-racket markdown-mode quickrun rainbow-delimiters rust-mode slime slime-company yaml-mode))
